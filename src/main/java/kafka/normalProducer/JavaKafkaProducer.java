...
public class JavaKafkaProducer {
    ...
    public static final String TOPIC_NAME = "test01";
    ...
    public static void main(String[] args) {
         ...
         */
        props.put("partitioner.class", "kafka.normalProducer.JavaKafkaProducerPartitioner");
        ...
        // 4. 发送数据到服务器，并发线程发送(具有原子性，能够保证在高并发的情况下只有一个线程能够访问这个属性值)
